      ...
      >
        ...
        {!showWaitlist ? (
          ...
          >
            ...
            <button onClick={() => setShowWaitlist(true)} className="nav-cta">
              Join Waitlist
            </button>
          </motion.div>
        ) : (
          ...
          >
            ...
            {/* Copy & Form or Success Ticket */}
            {!submitted ? (
              <>
                {/* Copy in the middle */}
                <div className="waitlist-copy" style={{ margin: "auto 0" }}>
              ...
              <div className="success-state" style={{ flexGrow: 1, display: "flex", flexDirection: "column", justifyContent: "space-between", gap: 16 }}>
                <div className="brand-pill" style={{ alignSelf: "flex-start" }}>YOU’RE IN</div>
                ...
                <div className="ticket-wrapper">
                  ...
                  <div className="ticket-row">
                    ...
                    <span className="ticket-value" style={{ maxWidth: "140px", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      {sessionData?.email}
                    </span>
                  </div>
                  <div className="ticket-row">
